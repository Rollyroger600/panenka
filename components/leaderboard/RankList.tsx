...
export function RankList({ participants, currentInitials, startRank = 4, scoreKey, scoreLabel }: Props) {
  ...
  return (
    <div className="rounded-xl bg-[#161616] border border-[#2a2a2a] overflow-hidden">
      {isSingle ? (
        <>
          <div className="grid grid-cols-[2rem_1fr_4rem] gap-1 px-3 py-2 bg-[#111] text-[10px] text-[#888] uppercase tracking-wide">
            <span>#</span>
            <span>Naam</span>
          ...
          {participants.map((p, i) => {
            ...
            return (
              <div
                key={p.initials}
                className={`grid grid-cols-[2rem_1fr_4rem] gap-1 px-3 py-2.5 border-t border-[#1a1a1a] items-center ${
        ...
        <>
          <div className="grid grid-cols-[2rem_1fr_3rem_3rem_3rem_3rem] gap-1 px-3 py-2 bg-[#111] text-[10px] text-[#888] uppercase tracking-wide">
            <span>#</span>
            <span>Naam</span>
