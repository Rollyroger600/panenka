...
const TYPES_KEUZE: AntwoordType[] = ['ja_nee', 'nl_opp', 'speler_nl', 'speler_opp', 'speler_beide', 'links_rechts', 'percentage', 'exact_aantal', 'exact_aantal_hoog', 'aantal_marge', 'decimaal', 'minuut', 'open', 'anders']
